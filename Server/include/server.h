...
class Server {
    ...
    public:
        ...
        Server(io_context& io_context_, const std::string &conKey, int port, DatabaseInitializer dbInitializer, const std::string &serverCrt, const std::string &serverKey);
        void accept_();
};
